...
describe.skip('stdin context', () => {
    ...
    it('should be able to use stdin as context for a prompt', async () => {
        ...
        expect(stdinIndex < promptIndex, `Expected stdin content (index ${stdinIndex}) to appear before prompt (index ${promptIndex}) in conversation history`).toBeTruthy();
        ...
        expect(result.toLowerCase().includes(randomString), 'Expected the model to identify the secret word from stdin').toBeTruthy();
    });
