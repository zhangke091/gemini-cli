        ...
        children: _jsx(SettingsContext.Provider, {
          ...
          children: _jsx(UIStateContext.Provider, {
            ...
            children: _jsx(VimModeProvider, {
              ...
              children: _jsx(ShellFocusContext.Provider, {
                value: shellFocus,
                children: _jsx(StreamingContext.Provider, {
                  value: finalUiState.streamingState,
                  children: _jsx(UIActionsContext.Provider, {
                    value: finalUIActions,
                    children: _jsx(ToolActionsProvider, {
                      config: config,
                      toolCalls: allToolCalls,
                      children: _jsx(AskUserActionsProvider, {
                        request: null,
                        onSubmit: vi.fn(),
                        onCancel: vi.fn(),
                        children: _jsx(KeypressProvider, {
                          children: _jsx(MouseProvider, {
...
export function renderHookWithProviders(renderCallback, options = {}) {
  ...
  act(() => {
    renderResult = renderWithProviders(
      _jsx(Wrapper, {
        children: _jsx(TestComponent, { initialProps: options.initialProps }),
      }),
      options,
    );
  });
