...
export class Session {
    ...
    connection;
    pendingPrompt = null;
    constructor(id, chat, config, connection) {
        this.id = id;
        this.chat = chat;
        this.config = config;
        this.connection = connection;
    ...
    async prompt(params) {
        ...
        while (nextMessage !== null) {
            ...
            const functionCalls = [];
            try {
                const model = resolveModel(this.config.getModel(), this.config.getPreviewFeatures());
