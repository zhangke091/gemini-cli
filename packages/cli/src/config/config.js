...
export async function loadCliConfig(settings, sessionId, argv, options = {}) {
    ...
    return new Config({
        ...
        enableEventDrivenScheduler: settings.experimental?.enableEventDrivenScheduler,
