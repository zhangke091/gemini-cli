...
describe('SettingsSchema', () => {
    describe('getSettingsSchema', () => {
        ...
        it('should have fileFiltering nested properties', () => {
            ...
            expect(getSettingsSchema().context.properties.fileFiltering.properties
                ?.customIgnoreFilePaths).toBeDefined();
            expect(getSettingsSchema().context.properties.fileFiltering.properties
                ?.customIgnoreFilePaths.type).toBe('array');
        });
        ...
        it('should have enableEventDrivenScheduler setting in schema', () => {
            const setting = getSettingsSchema().experimental.properties.enableEventDrivenScheduler;
            expect(setting).toBeDefined();
            expect(setting.type).toBe('boolean');
            expect(setting.category).toBe('Experimental');
            expect(setting.default).toBe(true);
            expect(setting.requiresRestart).toBe(true);
            expect(setting.showInDialog).toBe(false);
            expect(setting.description).toBe('Enables event-driven scheduler within the CLI session.');
        });
