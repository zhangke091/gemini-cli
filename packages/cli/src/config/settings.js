...
export class LoadedSettings {
    ...
    setRemoteAdminSettings(remoteSettings) {
        const admin = {};
        const { secureModeEnabled, strictModeDisabled, mcpSetting, cliFeatureSetting, } = remoteSettings;
 ...
 */
export function migrateDeprecatedSettings(loadedSettings, removeDeprecated = false) {
    ...
    const processScope = (scope) => {
        ...
        anyModified ||= migrateExperimentalSettings(settings, loadedSettings, scope, removeDeprecated);
    };
...
function migrateExperimentalSettings(settings, loadedSettings, scope, removeDeprecated) {
