...
import { makeFakeConfig, CoreEvent, AuthType, UserAccountManager, } from '@google/gemini-cli-core';
// Mock coreEvents
...
describe('AppContainer State Management', () => {
    ...
    describe('Authentication Check', () => {
        it('displays correct message for LOGIN_WITH_GOOGLE auth type', async () => {
            ...
            mockUserAccountManager.getCachedGoogleAccount.mockReturnValue('test@example.com');
            ...
            vi.spyOn(authConfig, 'getExtensionLoader').mockReturnValue(mockExtensionManager);
            ...
            await waitFor(() => {
                ...
                expect(mockUserAccountManager.getCachedGoogleAccount).toHaveBeenCalled();
