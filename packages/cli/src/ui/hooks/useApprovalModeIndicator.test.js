...
vi.mock('@google/gemini-cli-core', async () => {
    ...
    return {
        ...actualServerModule,
        Config: vi.fn(),
        getAdminErrorMessage: vi.fn((featureName) => `[Mock] ${featureName} is disabled`),
    };
});
describe('useApprovalModeIndicator', () => {
    ...
    it('should initialize with ApprovalMode.AUTO_EDIT if config.getApprovalMode returns ApprovalMode.AUTO_EDIT', () => {
        ...
        const { result } = renderHook(() => useApprovalModeIndicator({
    ...
    it('should cycle through DEFAULT -> AUTO_EDIT -> PLAN -> DEFAULT when plan is enabled', () => {
        ...
        renderHook(() => useApprovalModeIndicator({
            config: mockConfigInstance,
            addItem: vi.fn(),
        }));
        // DEFAULT -> AUTO_EDIT
    ...
    it('should update indicator when config value changes externally (useEffect dependency)', () => {
        mockConfigInstance.getApprovalMode.mockReturnValue(ApprovalMode.DEFAULT);
        const { result, rerender } = renderHook((props) => useApprovalModeIndicator(props), {
            initialProps: {
                config: mockConfigInstance,
                addItem: vi.fn(),
            },
...
//# sourceMappingURL=useApprovalModeIndicator.test.js.map