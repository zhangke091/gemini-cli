...
const mockUseUIState = useUIState;
const mockRecordFlickerFrame = recordFlickerFrame;
const mockMeasureElement = measureElement;
const mockAppEventsEmit = appEvents.emit;
describe('useFlickerDetector', () => {
    const mockConfig = {};
    let mockRef;
    beforeEach(() => {
        mockUseConfig.mockReturnValue(mockConfig);
        mockRef = { current: { yogaNode: {} } };
        // Default UI state
...
//# sourceMappingURL=useFlickerDetector.test.js.map