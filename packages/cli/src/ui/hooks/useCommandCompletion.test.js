...
describe('useCommandCompletion', () => {
    ...
    const renderCommandCompletionHook = (initialText, cursorOffset, shellModeActive = false) => {
        ...
        function TestComponent() {
            ...
            const completion = useCommandCompletion(textBuffer, testRootDir, [], mockCommandContext, false, shellModeActive, mockConfig);
    ...
    describe('prompt completion filtering', () => {
        it('should not trigger prompt completion for line comments', async () => {
            ...
            function TestComponent() {
                ...
                const completion = useCommandCompletion(textBuffer, testRootDir, [], mockCommandContext, false, false, mockConfig);
                hookResult = { ...completion, textBuffer };
                return null;
            }
            renderWithProviders(_jsx(TestComponent, {}));
