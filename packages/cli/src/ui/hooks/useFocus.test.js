...
describe('useFocus', () => {
    ...
    beforeEach(() => {
        ...
        stdout = { write: vi.fn() };
        mockedUseStdin.mockReturnValue({ stdin });
        mockedUseStdout.mockReturnValue({ stdout });
    });
    afterEach(() => {
        vi.clearAllMocks();
    ...
    const renderFocusHook = () => {
        ...
        const { unmount } = render(_jsx(KeypressProvider, { children: _jsx(TestComponent, {}) }));
        return {
            result: {
                get current() {
                    return hookResult;
...
//# sourceMappingURL=useFocus.test.js.map