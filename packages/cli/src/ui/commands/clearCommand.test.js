...
describe('clearCommand', () => {
  ...
  it('should set debug message, reset chat, reset telemetry, and clear UI when config is available', async () => {
    ...
    const setDebugMessageOrder =
      mockContext.ui.setDebugMessage.mock.invocationCallOrder[0];
    const resetChatOrder = mockResetChat.mock.invocationCallOrder[0];
    const resetTelemetryOrder =
      uiTelemetryService.setLastPromptTokenCount.mock.invocationCallOrder[0];
    const clearOrder = mockContext.ui.clear.mock.invocationCallOrder[0];
