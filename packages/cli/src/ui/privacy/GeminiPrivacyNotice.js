  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Text, {
        ...
        children: 'Gemini API Key Notice',
      }),
      _jsx(Newline, {}),
      _jsxs(Text, {
        ...
        children: [
          ...
          _jsx(Text, { color: theme.text.link, children: '[1]' }),
          ', Google AI Studio',
          _jsx(Text, { color: theme.status.error, children: '[2]' }),
          ...
          _jsx(Text, { color: theme.status.success, children: '[3]' }),
          ', and the Gemini API Additional Terms of Service (the "Additional Terms")',
          _jsx(Text, { color: theme.text.accent, children: '[4]' }),
          '.',
        ],
      }),
      _jsx(Newline, {}),
