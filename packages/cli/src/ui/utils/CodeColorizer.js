...
function renderHastNode(node, theme, inheritedColor) {
  ...
  if (node.type === 'element') {
    ...
    const children = node.children?.map((child, index) =>
      _jsx(
        React.Fragment,
        { children: renderHastNode(child, theme, colorToPassDown) },
        index,
      ),
    );
  ...
  if (node.type === 'root') {
    ...
    return node.children?.map((child, index) =>
      _jsx(
        React.Fragment,
        { children: renderHastNode(child, theme, inheritedColor) },
        index,
      ),
    );
  }
          ...
          children: [
            showLineNumbers &&
              _jsx(Box, {
                ...
                children: _jsx(Text, {
                  color: activeTheme.colors.Gray,
                  children: `${index + 1 + hiddenLinesCount}`,
                }),
              }),
            _jsx(Text, {
              color: activeTheme.defaultColor,
              wrap: 'wrap',
      ...
      _jsxs(
        Box,
        {
          ...
          children: [
            ...
            _jsx(Text, { color: activeTheme.colors.Gray, children: line }),
          ],
        },
        index,
      ),
