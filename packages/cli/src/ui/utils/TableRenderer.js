...
export const TableRenderer = ({ headers, rows, terminalWidth }) => {
      ...
      children: [
        isHeader
          ? _jsx(Text, {
              ...
              children: _jsx(RenderInline, { text: cellContent }),
            })
          : _jsx(RenderInline, { text: cellContent }),
  ...
  const renderRow = (cells, isHeader = false) => {
    ...
    return _jsxs(Text, {
      ...
      children: [
        _jsx(Text, { color: theme.border.default, children: '\u2502' }),
        ' ',
  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      renderBorder('middle'),
      rows.map((row, index) =>
        _jsx(React.Fragment, { children: renderRow(row) }, index),
      ),
      renderBorder('bottom'),
    ],
  });
