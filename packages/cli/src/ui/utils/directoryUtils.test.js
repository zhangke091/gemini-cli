...
const mockHomeDir = process.platform === 'win32' ? 'C:\\Users\\testuser' : '/home/testuser';
...
function createMockDir(entries) {
    let index = 0;
    const iterator = {
        async next() {
...
describe('directoryUtils', () => {
    ...
    describe('getDirectorySuggestions', () => {
        it('should return suggestions for an empty path', async () => {
            ...
            vi.mocked(fsPromises.opendir).mockResolvedValue(createMockDir([
        ...
        it('should limit results to 50 suggestions', async () => {
            ...
            vi.mocked(fsPromises.opendir).mockResolvedValue(createMockDir(manyDirs));
            const suggestions = await getDirectorySuggestions('');
        ...
        it('should terminate early after 150 matches for performance', async () => {
            ...
            vi.mocked(fsPromises.opendir).mockResolvedValue(mockDir);
    ...
    describe.skipIf(process.platform !== 'win32')('getDirectorySuggestions (Windows)', () => {
...
//# sourceMappingURL=directoryUtils.test.js.map