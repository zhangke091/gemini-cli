...
export const InputPrompt = ({
  ...
  const suggestionsNode = shouldShowSuggestions
    ? _jsx(Box, {
        paddingRight: 2,
        children: _jsx(SuggestionsDisplay, {
                ...
                buffer.text.length === 0 && placeholder
                  ...
                  : linesToRender
                      .map((lineText, visualIdxInRenderedSet) => {
                        ...
                        const currentLineGhost = isOnCursorLine
                          ? inlineGhost
                          : '';
                        if (
                          isOnCursorLine &&
                          ...
                          if (!currentLineGhost) {
                            renderedLine.push(
                              _jsx(
                                ...
                                `cursor-end-${cursorVisualColAbsolute}`,
                              ),
                            );
                          }
                        }
                      ...
                      .concat(
                        additionalLines.map((ghostLine, index) => {
                          ...
                          return _jsxs(
                            ...
                            {
                              color: theme.text.secondary,
                              children: [ghostLine, ' '.repeat(padding)],
                            },
                            `ghost-line-${index}`,
                          );
                        }),
