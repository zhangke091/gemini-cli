  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      _jsxs(Text, {
        ...
        children: [score, toggleHint ? ` (${toggleHint})` : ''],
      }),
    ],
  });
};
const ChecklistListDisplay = ({ items }) =>
  _jsx(Box, {
  ...
  return _jsx(Box, {
    ...
    children: isExpanded
      ? _jsxs(Box, {
          ...
          rowGap: 1,
          children: [
            _jsx(ChecklistTitleDisplay, {
              title: title,
              items: items,
              toggleHint: toggleHint,
            }),
            _jsx(ChecklistListDisplay, { items: items }),
          ],
        })
      : _jsxs(Box, {
          flexDirection: 'row',
          ...
          children: [
            _jsx(Box, {
              flexShrink: 0,
              flexGrow: 0,
              children: _jsx(ChecklistTitleDisplay, {
                title: title,
                items: items,
                toggleHint: toggleHint,
              }),
