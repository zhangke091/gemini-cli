    ...
    children: [
      ...
      _jsxs(Text, {
        ...
        children: [
          ...
          ': Use',
          ' ',
          _jsx(Text, { bold: true, color: theme.text.accent, children: '@' }),
          ' ',
      ...
      _jsxs(Text, {
        color: theme.text.primary,
        children: [
          _jsx(Text, { color: theme.text.secondary, children: '[MCP]' }),
      ...
      _jsxs(Text, {
        color: theme.text.primary,
        children: [
          _jsx(Text, { bold: true, color: theme.text.accent, children: 'Esc' }),
          ' ',
      ...
      _jsxs(Text, {
        ...
        children: [
          ...
          _jsx(Text, {
            bold: true,
            color: theme.text.accent,
            children: KEYBOARD_SHORTCUTS_URL,
          }),
        ],
      }),
    ],
