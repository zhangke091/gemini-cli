...
export const RewindConfirmation = ({
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Box, {
        marginBottom: 1,
        children: _jsx(Text, { bold: true, children: 'Confirm Rewind' }),
      }),
      stats &&
        _jsxs(Box, {
          flexDirection: 'column',
            ...
            _jsxs(Box, {
              ...
              children: [
                _jsxs(Text, {
                  ...
                  children: ['Lines added: ', stats.addedLines, ' '],
                }),
                _jsxs(Text, {
                  color: theme.status.error,
                  children: ['Lines removed: ', stats.removedLines],
                }),
                timestamp &&
                  _jsxs(Text, {
      ...
      !stats &&
        _jsxs(Box, {
          ...
          children: [
            _jsx(Text, {
              color: theme.text.secondary,
              children: 'No code changes to revert.',
            }),
            timestamp &&
              _jsxs(Text, {
                color: theme.text.secondary,
      ...
      _jsx(Box, {
        marginBottom: 1,
        children: _jsx(Text, { children: 'Select an action:' }),
      }),
