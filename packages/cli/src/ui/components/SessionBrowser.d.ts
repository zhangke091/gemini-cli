 ...
 */
export declare const useSessionBrowserState: (
 ...
 */
export declare const useMoveSelection: (
  state: SessionBrowserState,
) => (delta: number) => void;
/**
 * Hook to handle sort order cycling.
 */
export declare const useCycleSortOrder: (
  state: SessionBrowserState,
) => () => void;
/**
 * Hook to handle SessionBrowser input.
 */
export declare const useSessionBrowserInput: (
  state: SessionBrowserState,
...
export declare function SessionBrowserView({
  state,
}: {
  state: SessionBrowserState;
}): React.JSX.Element;
export declare function SessionBrowser({
  config,
  onResumeSession,
  onDeleteSession,
  onExit,
