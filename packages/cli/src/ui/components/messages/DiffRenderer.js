...
export const DiffRenderer = ({
  ...
  const renderedOutput = useMemo(() => {
    if (!diffContent || typeof diffContent !== 'string') {
      return _jsx(Text, {
        color: semanticTheme.status.warning,
    ...
    if (screenReaderEnabled) {
      return _jsx(Box, {
        ...
        children: parsedLines.map((line, index) =>
          _jsxs(Text, { children: [line.type, ': ', line.content] }, index),
        ),
      });
    }
    if (isNewFile) {
          ...
          children: [
            _jsx(Box, {
              ...
              children: _jsx(Text, {
                ...
                children: gutterNumStr,
              }),
            }),
            line.type === 'context'
              ? _jsxs(_Fragment, {
                  children: [
                    _jsxs(Text, { children: [prefixSymbol, ' '] }),
                    _jsx(Text, {
                      wrap: 'wrap',
                      children: colorizeLine(displayContent, language),
                    }),
                  ],
                })
              : _jsxs(Text, {
