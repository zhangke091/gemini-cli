...
vi.mock('../TerminalOutput.js', () => ({
  TerminalOutput: () => _jsx(Text, { children: 'MockTerminalOutput' }),
}));
vi.mock('../AnsiOutput.js', () => ({
  AnsiOutputText: () => _jsx(Text, { children: 'MockAnsiOutput' }),
}));
vi.mock('../GeminiRespondingSpinner.js', () => ({
  GeminiRespondingSpinner: () =>
    _jsx(Text, { children: 'MockRespondingSpinner' }),
}));
vi.mock('./DiffRenderer.js', () => ({
  DiffRenderer: () => _jsx(Text, { children: 'MockDiff' }),
}));
vi.mock('../../utils/MarkdownDisplay.js', () => ({
  MarkdownDisplay: ({ text }) => _jsx(Text, { children: text }),
}));
describe('ToolMessage Sticky Header Regression', () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });
  const createToolCall = (id, name, resultPrefix) => ({
    callId: id,
    name,
  ...
  it('verifies that multiple ToolMessages in a ToolGroupMessage in a ScrollableList have sticky headers', async () => {
    ...
    const { lastFrame } = renderWithProviders(
      _jsx(Box, { height: terminalHeight, children: _jsx(TestComponent, {}) }),
      {
        width: terminalWidth,
...
//# sourceMappingURL=ToolStickyHeaderRegression.test.js.map
