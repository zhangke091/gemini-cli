        ...
        children: questions.map((q, i) =>
          _jsxs(
            Box,
            {
              marginBottom: 0,
              children: [
                _jsx(Text, { color: theme.text.secondary, children: q.header }),
                _jsx(Text, {
  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      _jsxs(Box, {
        ...
        marginBottom: 1,
        children: [
          _jsx(Text, { color: theme.text.accent, children: '> ' }),
          _jsx(TextInput, {
            buffer: buffer,
...
const ChoiceQuestionView = ({
  ...
  const buildAnswerString = useCallback(
    (indices, includeCustomOption, customOption) => {
      const answers = [];
            ...
            children: [
              ...
              optionItem.description &&
                _jsxs(Text, {
                  color: theme.text.secondary,
                  wrap: 'wrap',
                  children: [' ', optionItem.description],
                }),
            ],
          });
        },
...
export const AskUserDialog = ({
  ...
  const keyboardHints = _jsx(DialogFooter, {
    primaryAction:
