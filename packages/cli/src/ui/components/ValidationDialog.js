    ...
    return _jsxs(Box, {
      ...
      children: [
        ...
        errorMessage &&
          _jsx(Box, {
            marginTop: 1,
            children: _jsx(Text, { children: errorMessage }),
          }),
        _jsx(Box, {
          marginTop: 1,
          children: _jsx(Text, {
            dimColor: true,
            children: 'Press Enter when verification is complete.',
          }),
        }),
      ],
    });
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Box, {
        marginBottom: 1,
        children: _jsx(Text, {
          children: 'Further action is required to use this service.',
        }),
      }),
      _jsx(Box, {
        marginTop: 1,
      ...
      learnMoreUrl &&
        _jsx(Box, {
          ...
          children: _jsxs(Text, {
            ...
            children: [
              'Learn more: ',
              _jsx(Text, { color: theme.text.accent, children: learnMoreUrl }),
            ],
          }),
        }),
    ],
