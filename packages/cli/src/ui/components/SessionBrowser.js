...
const Kbd = ({ name, shortcut }) =>
  _jsxs(_Fragment, {
    children: [name, ': ', _jsx(Text, { bold: true, children: shortcut })],
  });
/**
 * Loading state component displayed while sessions are being loaded.
 */
const SessionBrowserLoading = () =>
  _jsx(Box, {
 ...
 */
const SessionBrowserError = ({ state }) =>
  _jsxs(Box, {
    flexDirection: 'column',
    paddingX: 1,
    children: [
      ...
      _jsx(Text, { color: Colors.Gray, children: 'Press q to exit' }),
    ],
  });
/**
...
const SessionBrowserEmpty = () =>
  _jsxs(Box, {
    ...
    children: [
      _jsx(Text, {
        color: Colors.Gray,
        children: 'No auto-saved conversations found.',
      }),
      _jsx(Text, { color: Colors.Gray, children: 'Press q to exit' }),
    ],
  });
 ...
 */
const SearchModeDisplay = ({ state }) =>
  _jsxs(Box, {
    marginTop: 1,
    children: [
      _jsx(Text, { color: Colors.Gray, children: 'Search: ' }),
      _jsx(Text, { color: Colors.AccentPurple, children: state.searchQuery }),
      _jsx(Text, { color: Colors.Gray, children: ' (Esc to cancel)' }),
    ],
  });
/**
 * Header component showing session count and sort information.
 */
const SessionListHeader = ({ state }) =>
  _jsxs(Box, {
    flexDirection: 'row',
  ...
  _jsxs(Box, {
    ...
    children: [
      _jsxs(Text, {
        color: Colors.Gray,
        children: [
          _jsx(Kbd, { name: 'Navigate', shortcut: '\u2191/\u2193' }),
          '   ',
          _jsx(Kbd, { name: 'Resume', shortcut: 'Enter' }),
          '   ',
          _jsx(Kbd, { name: 'Search', shortcut: '/' }),
          '   ',
          _jsx(Kbd, { name: 'Delete', shortcut: 'x' }),
          '   ',
          _jsx(Kbd, { name: 'Quit', shortcut: 'q' }),
        ],
      }),
      _jsxs(Text, {
        color: Colors.Gray,
        children: [
          _jsx(Kbd, { name: 'Sort', shortcut: 's' }),
          '         ',
          _jsx(Kbd, { name: 'Reverse', shortcut: 'r' }),
          '      ',
          _jsx(Kbd, { name: 'First/Last', shortcut: 'g/G' }),
        ],
      }),
    ],
  });
 ...
 */
const SessionTableHeader = ({ state }) =>
  _jsxs(Box, {
    flexDirection: 'row',
    marginTop: 1,
    children: [
      _jsx(Text, {
        children:
          state.scrollOffset > 0 ? _jsx(Text, { children: '\u25B2 ' }) : '  ',
      }),
      _jsx(Box, {
        width: 5,
        flexShrink: 0,
      ...
      _jsx(Text, { color: Colors.Gray, children: ' \u2502 ' }),
      _jsx(Box, {
        width: 4,
        flexShrink: 0,
        children: _jsx(Text, {
      ...
      _jsx(Box, {
        ...
        children: _jsx(Text, {
          color: Colors.Gray,
          bold: true,
          children: state.searchQuery ? 'Match' : 'Name',
        }),
      }),
    ],
  });
 ...
 */
const NoResultsDisplay = ({ state }) =>
  _jsx(Box, {
    marginTop: 1,
    children: _jsxs(Text, {
      color: Colors.Gray,
      dimColor: true,
      children: ["No sessions found matching '", state.searchQuery, "'."],
    }),
  });
/**
...
const MatchSnippetDisplay = ({ session, textColor }) => {
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      firstMatch.before,
      _jsx(Text, {
        color: textColor(Colors.AccentRed),
        bold: true,
        children: firstMatch.match,
      }),
      firstMatch.after,
    ],
  });
...
const SessionItem = ({ session, state, terminalWidth, formatRelativeTime }) => {
  ...
  if (
    ...
    matchDisplay = _jsx(MatchSnippetDisplay, {
      session: session,
      textColor: textColor,
    });
    ...
    children: [
      ...
      _jsx(Box, {
        ...
        children: _jsx(Text, {
          color: textColor(),
          dimColor: isDisabled,
          children: formatRelativeTime(session.lastUpdated, 'short'),
        }),
      }),
      _jsxs(Text, {
        color: textColor(Colors.Gray),
      ...
      _jsx(Box, {
        flexGrow: 1,
        children: _jsxs(Text, {
          color: textColor(Colors.Comment),
          dimColor: isDisabled,
          children: [
            truncatedMessage,
            additionalInfo &&
 ...
 */
const SessionList = ({ state, formatRelativeTime }) =>
  _jsxs(Box, {
    flexDirection: 'column',
    children: [
      _jsxs(Box, {
        flexDirection: 'column',
        children: [
          !state.isSearchMode && _jsx(NavigationHelp, {}),
          _jsx(SessionTableHeader, { state: state }),
        ],
      }),
...
export function SessionBrowserView({ state }) {
  ...
  return _jsxs(Box, {
    ...
    paddingX: 1,
    children: [
      _jsx(SessionListHeader, { state: state }),
      state.isSearchMode && _jsx(SearchModeDisplay, { state: state }),
      state.totalSessions === 0
        ? _jsx(NoResultsDisplay, { state: state })
        : _jsx(SessionList, {
            state: state,
            formatRelativeTime: formatRelativeTime,
          }),
