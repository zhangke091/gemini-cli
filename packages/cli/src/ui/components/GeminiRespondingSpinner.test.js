...
describe('GeminiRespondingSpinner', () => {
    ...
    it('renders spinner when responding', () => {
        ...
        const { lastFrame } = render(_jsx(GeminiRespondingSpinner, {}));
    ...
    it('renders non-responding display when provided', () => {
        mockUseStreamingContext.mockReturnValue(StreamingState.Idle);
        const { lastFrame } = render(_jsx(GeminiRespondingSpinner, { nonRespondingDisplay: "Waiting..." }));
...
//# sourceMappingURL=GeminiRespondingSpinner.test.js.map