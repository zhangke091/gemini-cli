                  ...
                  _jsxs(Text, {
                    ...
                    children: [
                      ...
                      _jsx(Text, {
                        ...
                        children: otherScopeModifiedMessage,
                      }),
                    ],
                  }),
                  _jsx(RadioButtonSelect, {
                    ...
                    renderItem: (item, { titleColor }) => {
                      ...
                      if (item.themeNameDisplay && item.themeTypeDisplay) {
                        const match =
                          item.themeNameDisplay.match(/^(.*) \((.*)\)$/);
                        let themeNamePart = item.themeNameDisplay;
                        if (match) {
                          themeNamePart = _jsxs(_Fragment, {
                            children: [
                              match[1],
                              ' ',
                              _jsxs(Text, {
                            ...
                            children: [
                              ...
                              itemWithExtras.themeMatch &&
                                _jsx(Text, {
                                  ...
                                  children: itemWithExtras.themeMatch,
                                }),
                              itemWithExtras.themeWarning &&
                                _jsx(Text, {
                                  color: theme.status.warning,
                                  children: itemWithExtras.themeWarning,
                                }),
                            ],
                          },
                          item.key,
