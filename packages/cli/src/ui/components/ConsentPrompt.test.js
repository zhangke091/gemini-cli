...
describe('ConsentPrompt', () => {
    ...
    it('renders a string prompt with MarkdownDisplay', () => {
        ...
        const { unmount } = render(_jsx(ConsentPrompt, { prompt: prompt, onConfirm: onConfirm, terminalWidth: terminalWidth }));
    ...
    it('renders a ReactNode prompt directly', () => {
        ...
        const { lastFrame, unmount } = render(_jsx(ConsentPrompt, { prompt: prompt, onConfirm: onConfirm, terminalWidth: terminalWidth }));
