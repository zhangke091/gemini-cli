...
export function ModelDialog({ onClose }) {
  ...
  return _jsxs(Box, {
    ...
    width: '100%',
    children: [
      _jsx(Text, { bold: true, children: 'Select Model' }),
      _jsxs(Box, {
        flexDirection: 'column',
        children: [
          header &&
            _jsx(Box, {
              marginTop: 1,
              children: _jsx(ThemedGradient, {
                children: _jsx(Text, { children: header }),
              }),
            }),
          subheader && _jsx(Text, { children: subheader }),
        ],
      }),
      _jsx(Box, {
        marginTop: 1,
        children: _jsx(DescriptiveRadioButtonSelect, {
          items: options,
          ...
          _jsxs(Box, {
            children: [
              _jsxs(Text, {
                ...
                children: ['Remember model for future sessions:', ' '],
              }),
              _jsx(Text, {
                color: theme.status.success,
                children: persistMode ? 'true' : 'false',
              }),
            ],
          }),
          _jsx(Text, {
            color: theme.text.secondary,
            children: '(Press Tab to toggle)',
          }),
        ],
      }),
      _jsx(Box, {
