  ...
  if (activeModels.length === 0) {
    return _jsx(Box, {
      ...
      children: _jsx(Text, {
        ...
        children: 'No API calls have been made in this session.',
      }),
    });
  }
  ...
  rows.push(
    createRow('Total', (m) =>
      _jsx(Text, {
        ...
        children: m.tokens.total.toLocaleString(),
      }),
    ),
  );
  rows.push(
    createRow(
      ...
      (m) =>
        _jsx(Text, {
          color: theme.text.primary,
          children: m.tokens.input.toLocaleString(),
        }),
      { isSubtle: true },
    ),
  );
    ...
    rows.push(
      createRow(
        ...
        (m) =>
          _jsx(Text, {
            color: theme.text.primary,
            children: m.tokens.thoughts.toLocaleString(),
          }),
        { isSubtle: true },
      ),
    );
    ...
    rows.push(
      createRow(
        ...
        (m) =>
          _jsx(Text, {
            color: theme.text.primary,
            children: m.tokens.tool.toLocaleString(),
          }),
        { isSubtle: true },
      ),
    );
  ...
  rows.push(
    createRow(
      ...
      (m) =>
        _jsx(Text, {
          color: theme.text.primary,
          children: m.tokens.candidates.toLocaleString(),
        }),
      { isSubtle: true },
    ),
  );
  const columns = [
    {
      ...
      renderCell: (row) =>
        _jsx(Text, {
          ...
          children: row.isSubtle ? `  ↳ ${row.metric}` : row.metric,
        }),
    },
    ...modelNames.map((name) => ({
      key: name,
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Text, {
        ...
        children: 'Model Stats For Nerds',
      }),
      _jsx(Box, { height: 1 }),
      showUserIdentity &&
        selectedAuthType &&
      ...
      showUserIdentity &&
        ...
        _jsxs(Box, {
          children: [
            ...
            _jsx(Text, { color: theme.text.primary, children: tier }),
          ],
        }),
      showUserIdentity &&
        (selectedAuthType || tier) &&
        _jsx(Box, { height: 1 }),
      _jsx(Table, { data: rows, columns: columns }),
    ],
  });
};
