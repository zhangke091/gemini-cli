...
vi.mock('@google/gemini-cli-core', async (importOriginal) => {
  ...
  return {
    ...actual,
    openBrowserSecurely: (...args) => mockOpenBrowserSecurely(...args),
    shouldLaunchBrowser: () => mockShouldLaunchBrowser(),
  };
});
// Capture keypress handler to test it
let mockKeypressHandler;
let mockKeypressOptions;
  ...
  describe('initial render (choosing state)', () => {
    it('should render the main message and two options', () => {
      const { lastFrame, unmount } = render(
        _jsx(ValidationDialog, { onChoice: mockOnChoice }),
      );
...
//# sourceMappingURL=ValidationDialog.test.js.map
