...
export const DetailedMessagesDisplay = ({
  messages,
  maxHeight,
  width,
  hasFocus,
            ...
            return _jsxs(Box, {
              ...
              children: [
                _jsx(Box, {
                  ...
                  flexShrink: 0,
                  children: _jsx(Text, { color: textColor, children: icon }),
                }),
                _jsxs(Text, {
                  color: textColor,
                  wrap: 'wrap',
