...
vi.mock('./LoadingIndicator.js', () => ({
  LoadingIndicator: ({ thought }) =>
    _jsxs(Text, {
      children: ['LoadingIndicator', thought ? `: ${thought}` : ''],
    }),
}));
vi.mock('./ContextSummaryDisplay.js', () => ({
  ContextSummaryDisplay: () =>
    _jsx(Text, { children: 'ContextSummaryDisplay' }),
}));
...
vi.mock('./ApprovalModeIndicator.js', () => ({
  ApprovalModeIndicator: () =>
    _jsx(Text, { children: 'ApprovalModeIndicator' }),
}));
...
vi.mock('./DetailedMessagesDisplay.js', () => ({
  DetailedMessagesDisplay: () =>
    _jsx(Text, { children: 'DetailedMessagesDisplay' }),
}));
vi.mock('./InputPrompt.js', () => ({
  InputPrompt: ({ placeholder }) =>
    _jsxs(Text, { children: ['InputPrompt: ', placeholder] }),
...
vi.mock('./QueuedMessageDisplay.js', () => ({
  QueuedMessageDisplay: ({ messageQueue }) => {
    ...
    return _jsx(_Fragment, {
      children: messageQueue.map((message, index) =>
        _jsx(Text, { children: message }, index),
      ),
    });
  },
}));
...
const renderComposer = (
  ...
  render(
    _jsx(ConfigContext.Provider, {
      value: config,
      children: _jsx(SettingsContext.Provider, {
        value: settings,
        children: _jsx(UIStateContext.Provider, {
          value: uiState,
          children: _jsx(UIActionsContext.Provider, {
            value: uiActions,
            children: _jsx(Composer, {}),
          }),
        }),
      }),
    }),
