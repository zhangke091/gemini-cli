...
export const McpStatus = ({
  ...
  if (serverNames.length === 0 && blockedServers.length === 0) {
    return _jsxs(Box, {
      ...
      children: [
        _jsx(Text, { children: 'No MCP servers configured.' }),
        _jsxs(Text, {
          children: [
            ...
            _jsx(Text, {
              ...
              children: 'https://goo.gle/gemini-cli-docs-mcp',
            }),
            ' ',
  ...
  return _jsxs(Box, {
    ...
    children: [
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Text, {
              ...
              children: [
                '\u23F3 MCP servers are starting up (',
                connectingServers.length,
                ' ',
                'initializing)...',
              ],
            }),
      ...
      _jsx(Text, { bold: true, children: 'Configured MCP servers:' }),
      _jsx(Box, { height: 1 }),
      serverNames.map((serverName) => {
        ...
        if (serverAuthStatus === 'authenticated') {
          ...
          authStatusNode = _jsx(Text, {
            color: theme.status.error,
            children: ' (OAuth expired)',
          });
        } else if (serverAuthStatus === 'unauthenticated') {
          authStatusNode = _jsx(Text, {
            color: theme.status.warning,
            children: ' (OAuth not authenticated)',
          });
        }
        return _jsxs(
          Box,
            ...
            children: [
              _jsxs(Box, {
                children: [
                  ...
                  _jsx(Text, { bold: true, children: serverDisplayName }),
                  _jsxs(Text, {
                    children: [
                      ' - ',
                      statusText,
              ...
              status === MCPServerStatus.CONNECTING &&
                _jsx(Text, {
                  children: ' (tools and prompts will appear when ready)',
                }),
              status === MCPServerStatus.DISCONNECTED &&
                toolCount > 0 &&
                _jsxs(Text, { children: [' (', toolCount, ' tools cached)'] }),
              showDescriptions &&
                server?.description &&
                _jsx(Text, {
                  color: theme.text.secondary,
                  children: server.description.trim(),
                }),
              serverTools.length > 0 &&
                _jsxs(Box, {
                  flexDirection: 'column',
                          ...
                          children: [
                            ...
                            showDescriptions &&
                              ...
                              _jsx(Box, {
                                ...
                                children: _jsx(Text, {
                                  color: theme.text.secondary,
                                  children: tool.description.trim(),
                                }),
                              }),
                            schemaContent &&
                              _jsxs(Box, {
                          ...
                          children: [
                            ...
                            showDescriptions &&
                              ...
                              _jsx(Box, {
                                ...
                                children: _jsx(Text, {
                                  color: theme.text.primary,
                                  children: prompt.description.trim(),
                                }),
                              }),
                          ],
                        },
                ...
                _jsxs(Box, {
                  ...
                  children: [
                    ...
                    serverResources
                      ...
                      .map((resource, index) => {
                        const label =
                          resource.name || resource.uri || 'resource';
                        return _jsxs(
                          Box,
                          {
                            flexDirection: 'column',
                            children: [
                              ...
                              showDescriptions &&
                                ...
                                _jsx(Box, {
                                  ...
                                  children: _jsx(Text, {
                                    color: theme.text.secondary,
                                    children: resource.description.trim(),
                                  }),
                                }),
                            ],
                          },
                          `${resource.serverName}-resource-${index}`,
                        );
                      }),
