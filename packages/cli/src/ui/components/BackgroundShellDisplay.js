    ...
    return _jsxs(Box, {
      ...
      children: [
        _jsx(Box, {
          ...
          children: _jsx(Text, {
            bold: true,
            children: `Select Process (${commandDescriptions[Command.BACKGROUND_SHELL_SELECT]} to select, ${commandDescriptions[Command.BACKGROUND_SHELL_ESCAPE]} to cancel):`,
          }),
        }),
        _jsx(Box, {
          flexGrow: 1,
          ...
          children: _jsx(RadioButtonSelect, {
            ...
            renderItem: (
              ...
              if (!shell) return _jsx(Text, { children: item.label });
              const truncatedCommand = formatShellCommandForDisplay(
                shell.command,
                maxCommandLength,
              );
                    ...
                    ? _jsxs(Text, {
                        color:
                          shell.exitCode === 0
                            ...
                            : theme.status.error,
                        children: [' ', '(Exit Code: ', shell.exitCode, ')'],
                      })
                    : null,
                ],
              });
    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          ...
          _jsx(Text, { color: theme.text.accent, children: helpText }),
        ],
      }),
      _jsx(Box, {
        flexGrow: 1,
        ...
        children: isListOpenProp ? renderProcessList() : renderOutput(),
      }),
    ],
  });
};
