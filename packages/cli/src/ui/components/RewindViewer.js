...
export const RewindViewer = ({ conversation, onExit, onRewind }) => {
  ...
  if (selectedMessageId) {
    if (isRewinding) {
      return _jsxs(Box, {
        ...
        flexDirection: 'row',
        children: [
          _jsx(Box, { children: _jsx(CliSpinner, {}) }),
          _jsx(Text, { children: 'Rewinding...' }),
        ],
      });
    }
    ...
    return _jsx(RewindConfirmation, {
  ...
  return _jsxs(Box, {
    ...
    children: [
      _jsx(Box, {
        marginBottom: 1,
        children: _jsxs(Text, { bold: true, children: ['> ', 'Rewind'] }),
      }),
      _jsx(Box, {
        flexDirection: 'column',
        flexGrow: 1,
        children: _jsx(BaseSelectionList, {
          items: items,
                ...
                children: [
                  _jsx(Text, {
                    color: isSelected
                      ...
                      : theme.text.primary,
                    children: partToString(
                      userPrompt.displayContent || userPrompt.content,
                    ),
                  }),
                  _jsx(Text, {
                    color: theme.text.secondary,
                    children: 'Cancel rewind and stay here',
                  }),
                ],
              });
            }
                  ...
                  ? _jsxs(Box, {
                      ...
                      children: [
                        ...
                        stats.addedLines > 0 &&
                          _jsxs(Text, {
                            color: 'green',
                            children: ['+', stats.addedLines, ' '],
                          }),
                        stats.removedLines > 0 &&
                          _jsxs(Text, {
                            color: 'red',
                            children: ['-', stats.removedLines],
                          }),
                      ],
                    })
                  : _jsx(Text, {
                      color: theme.text.secondary,
                      children: 'No files have been changed',
                    }),
              ],
            });
          },
