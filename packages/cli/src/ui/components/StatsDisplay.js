...
const Section = ({ title, children }) =>
  _jsxs(Box, {
    ...
    marginBottom: 1,
    children: [
      _jsx(Text, { bold: true, color: theme.text.primary, children: title }),
      children,
    ],
  });
          ...
          children: _jsxs(Text, {
            ...
            children: [
              _jsx(Text, {
                ...
                children: 'Savings Highlight:',
              }),
              ' ',
              totalCachedTokens.toLocaleString(),
              ' (',
              _jsxs(Text, {
                color: cacheEfficiencyColor,
                children: [cacheEfficiency.toFixed(1), '%'],
              }),
        ...
        _jsxs(_Fragment, {
          children: [
            _jsx(Box, {
              ...
              children: _jsx(Text, {
                color: theme.text.primary,
                children: `Usage limits span all sessions and reset daily.\n/auth to upgrade or switch to API key.`,
              }),
            }),
            _jsx(Text, {
              color: theme.text.secondary,
        ...
        children: [
          ...
          showUserIdentity &&
            ...
            _jsx(StatRow, {
              ...
              children: _jsx(Text, {
                color: theme.text.primary,
                children: selectedAuthType.startsWith('oauth')
                  ? userEmail
          ...
          _jsx(StatRow, {
            ...
            children: _jsxs(Text, {
              ...
              children: [
                ...
                _jsxs(Text, {
                  color: theme.status.success,
                  children: ['\u2713 ', tools.totalSuccess],
                }),
                ' ',
                _jsxs(Text, {
                  color: theme.status.error,
                  children: ['x ', tools.totalFail],
                }),
                ' )',
              ],
            }),
          ...
          _jsx(StatRow, {
            ...
            children: _jsxs(Text, {
              color: successColor,
              children: [computed.successRate.toFixed(1), '%'],
            }),
          }),
            ...
            _jsx(StatRow, {
              ...
              children: _jsxs(Text, {
                ...
                children: [
                  ...
                  _jsxs(Text, {
                    color: theme.text.secondary,
                    children: ['(', computed.totalDecisions, ' reviewed)'],
                  }),
                ],
              }),
            }),
            ...
            _jsx(StatRow, {
              ...
              children: _jsxs(Text, {
                ...
                children: [
                  _jsxs(Text, {
                    color: theme.status.success,
                    children: ['+', files.totalLinesAdded],
                  }),
                  ' ',
                  _jsxs(Text, {
                    color: theme.status.error,
                    children: ['-', files.totalLinesRemoved],
                  }),
                ],
              }),
            }),
      ...
      _jsxs(Section, {
        ...
        children: [
          ...
          _jsx(StatRow, {
            ...
            children: _jsx(Text, {
              color: theme.text.primary,
              children: formatDuration(computed.agentActiveTime),
            }),
          }),
          _jsx(SubStatRow, {
            title: 'API Time:',
            children: _jsxs(Text, {
              ...
              children: [
                ...
                _jsxs(Text, {
                  color: theme.text.secondary,
                  children: ['(', computed.apiTimePercent.toFixed(1), '%)'],
                }),
              ],
            }),
          }),
          _jsx(SubStatRow, {
            ...
            children: _jsxs(Text, {
              ...
              children: [
                ...
                _jsxs(Text, {
                  color: theme.text.secondary,
                  children: ['(', computed.toolTimePercent.toFixed(1), '%)'],
                }),
              ],
            }),
          }),
