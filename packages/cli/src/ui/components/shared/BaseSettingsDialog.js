      ...
      children: [
        _jsx(Box, {
          ...
          children: _jsxs(Text, {
            ...
            wrap: 'truncate',
            children: [focusSection === 'settings' ? '> ' : '  ', title, ' '],
          }),
        }),
        searchEnabled &&
          searchBuffer &&
          ...
          _jsxs(Box, {
            ...
            children: [
              _jsxs(Text, {
                ...
                wrap: 'truncate',
                children: [focusSection === 'scope' ? '> ' : '  ', 'Apply To'],
              }),
        ...
        _jsx(Box, {
          ...
          children: _jsxs(Text, {
            ...
            children: [
              ...
              showScopeSelector ? ', Tab to change focus' : '',
              ', Esc to close)',
            ],
          }),
        }),
        footerContent && _jsx(Box, { marginX: 1, children: footerContent }),
      ],
    }),
  });
}
