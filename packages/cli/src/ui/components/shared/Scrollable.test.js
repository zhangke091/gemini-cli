    ...
    renderWithProviders(
      _jsxs(Scrollable, {
        ...
        children: [
          ...
          _jsx(Text, { children: 'Line 2' }),
          _jsx(Text, { children: 'Line 3' }),
          _jsx(Text, { children: 'Line 4' }),
          _jsx(Text, { children: 'Line 5' }),
          _jsx(Text, { children: 'Line 6' }),
          _jsx(Text, { children: 'Line 7' }),
          _jsx(Text, { children: 'Line 8' }),
          _jsx(Text, { children: 'Line 9' }),
          _jsx(Text, { children: 'Line 10' }),
        ],
      }),
    );
