...
describe('<MaxSizedBox />', () => {
    ...
    const { lastFrame, unmount } = render(
      _jsx(OverflowProvider, {
        children: _jsx(MaxSizedBox, {
          ...
          maxHeight: 10,
          children: _jsx(Box, {
            children: _jsx(Text, { children: 'Hello, World!' }),
          }),
        }),
      }),
    );
      ...
      _jsx(OverflowProvider, {
        children: _jsx(MaxSizedBox, {
          ...
          children: _jsxs(Box, {
            ...
            children: [
              _jsx(Text, { children: 'Line 1' }),
              _jsx(Text, { children: 'Line 2' }),
              _jsx(Text, { children: 'Line 3' }),
            ],
          }),
        }),
      }),
    ...
    const { lastFrame, unmount } = render(
      _jsx(OverflowProvider, {
        children: _jsx(MaxSizedBox, {
          maxWidth: 80,
          maxHeight: 2,
          additionalHiddenLinesCount: 1,
          children: _jsx(Box, {
            flexDirection: 'column',
            children: _jsx(Text, { children: 'Line 1' }),
          }),
        }),
      }),
    );
      ...
      _jsx(OverflowProvider, {
        children: _jsx(MaxSizedBox, {
          ...
          children: _jsx(Box, {
            children: _jsx(Text, {
              wrap: 'wrap',
              children: 'This is a long line of text',
            }),
          }),
        }),
      }),
  ...
  it('renders an empty box for empty children', async () => {
    const { lastFrame, unmount } = render(
      _jsx(OverflowProvider, {
        children: _jsx(MaxSizedBox, { maxWidth: 80, maxHeight: 10 }),
      }),
    );
        ...
        children: _jsx(MaxSizedBox, {
          ...
          children: _jsxs(Box, {
            ...
            children: [
              _jsxs(_Fragment, {
                children: [
                  _jsx(Text, { children: 'Line 1 from Fragment' }),
                  _jsx(Text, { children: 'Line 2 from Fragment' }),
                ],
              }),
              _jsx(Text, { children: 'Line 3 direct child' }),
            ],
          }),
        }),
      }),
    ...
    const { lastFrame, unmount } = render(
      _jsx(OverflowProvider, {
        children: _jsx(MaxSizedBox, {
          ...
          children: _jsx(Box, {
            children: _jsx(Text, { children: THIRTY_LINES }),
          }),
        }),
      }),
    );
