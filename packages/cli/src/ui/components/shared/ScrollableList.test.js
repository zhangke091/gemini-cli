                  ...
                  _jsxs(Box, {
                    ...
                    children: [
                      index === 0
                        ? _jsx(Box, {
                            sticky: true,
                            stickyChildren: _jsxs(Text, {
                              children: ['[STICKY] ', item.title],
                            }),
                            children: _jsxs(Text, {
                              children: ['[Normal] ', item.title],
                            }),
                          })
                        : _jsxs(Text, { children: ['[Normal] ', item.title] }),
                      _jsxs(Text, { children: ['Content for ', item.title] }),
                      _jsxs(Text, {
                        children: ['More content for ', item.title],
                      }),
                    ],
                  }),
