  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      visibleSuggestions.map((suggestion, index) => {
        ...
        const labelElement = _jsx(ExpandableText, {
                ...
                children: _jsxs(Box, {
                  children: [
                    ...
                    suggestion.commandKind &&
                      ...
                      _jsx(Text, {
                        color: textColor,
                        children: COMMAND_KIND_SUFFIX[suggestion.commandKind],
                      }),
                  ],
                }),
              }),
              suggestion.description &&
                _jsx(Box, {
                  ...
                  children: _jsx(Text, {
                    color: textColor,
                    wrap: 'truncate',
                    children: sanitizeForDisplay(suggestion.description, 100),
                  }),
                }),
              isActive &&
                isLong &&
      ...
      suggestions.length > MAX_SUGGESTIONS_TO_SHOW &&
        _jsxs(Text, {
          color: 'gray',
          children: ['(', activeIndex + 1, '/', suggestions.length, ')'],
        }),
    ],
  });
}
