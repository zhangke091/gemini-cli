...
const StatRow = ({ name, stats }) => {
  ...
  return _jsxs(Box, {
    children: [
      _jsx(Box, {
        width: TOOL_NAME_COL_WIDTH,
        children: _jsx(Text, { color: theme.text.link, children: name }),
      }),
      _jsx(Box, {
        width: CALLS_COL_WIDTH,
...
export const ToolStatsDisplay = () => {
  ...
  if (activeTools.length === 0) {
    return _jsx(Box, {
      ...
      children: _jsx(Text, {
        color: theme.text.primary,
        children: 'No tool calls have been made in this session.',
      }),
    });
  }
  ...
  return _jsxs(Box, {
    ...
    children: [
      ...
      _jsx(Text, {
        bold: true,
        color: theme.text.primary,
        children: 'User Decision Summary',
      }),
      _jsxs(Box, {
        children: [
          _jsx(Box, {
            width:
              TOOL_NAME_COL_WIDTH + CALLS_COL_WIDTH + SUCCESS_RATE_COL_WIDTH,
            children: _jsx(Text, {
              color: theme.text.link,
              children: 'Total Reviewed Suggestions:',
            }),
          }),
          _jsx(Box, {
            width: AVG_DURATION_COL_WIDTH,
        ...
        children: [
          ...
          _jsx(Box, {
            ...
            children: _jsx(Text, {
              ...
              children: totalDecisions.accept,
            }),
          }),
        ],
      }),
        ...
        children: [
          ...
          _jsx(Box, {
            ...
            children: _jsx(Text, {
              ...
              children: totalDecisions.reject,
            }),
          }),
        ],
      }),
        ...
        children: [
          ...
          _jsx(Box, {
            ...
            children: _jsx(Text, {
              ...
              children: totalDecisions.modify,
            }),
          }),
        ],
      }),
      ...
      _jsxs(Box, {
        children: [
          _jsx(Box, {
            ...
            children: _jsx(Text, {
              color: theme.text.primary,
              children: ' Overall Agreement Rate:',
            }),
          }),
          _jsx(Box, {
            width: AVG_DURATION_COL_WIDTH,
            ...
            children: _jsx(Text, {
              bold: true,
              color: totalReviewed > 0 ? agreementColor : undefined,
              children:
