...
(function (MultiFolderTrustChoice) {
  ...
  MultiFolderTrustChoice[(MultiFolderTrustChoice['YES_AND_REMEMBER'] = 1)] =
    'YES_AND_REMEMBER';
  MultiFolderTrustChoice[(MultiFolderTrustChoice['NO'] = 2)] = 'NO';
})(MultiFolderTrustChoice || (MultiFolderTrustChoice = {}));
export const MultiFolderTrustDialog = ({
  folders,
  onComplete,
  trustedDirs,
    ...
    children: [
      ...
      submitted &&
        _jsx(Box, {
          ...
          children: _jsx(Text, {
            color: theme.text.primary,
            children: 'Applying trust settings...',
          }),
        }),
    ],
  });
