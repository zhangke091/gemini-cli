      ...
      showScreenReaderNudge &&
        _jsxs(Text, {
          children: [
            ...
            ' ',
            settingsPath,
            ' and remove the entry for ',
            '"screenReader"',
            '. This will disappear on next run.',
          ],
        }),
      updateInfo && _jsx(UpdateNotification, { message: updateInfo.message }),
      showStartupWarnings &&
        _jsx(Box, {
          borderStyle: 'round',
          ...
          children: startupWarnings.map((warning, index) =>
            _jsx(
              Text,
              { color: theme.status.warning, children: warning },
              index,
            ),
          ),
        }),
        ...
        _jsxs(Box, {
          ...
          children: [
            _jsxs(Text, {
              ...
              children: ['Initialization Error: ', initError],
            }),
            _jsxs(Text, {
              color: theme.status.error,
              children: [' ', 'Please check API key and configuration.'],
            }),
          ],
        }),
    ],
