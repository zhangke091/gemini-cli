...
describe('ApprovalModeIndicator', () => {
  it('renders correctly for AUTO_EDIT mode', () => {
    const { lastFrame } = render(
      _jsx(ApprovalModeIndicator, { approvalMode: ApprovalMode.AUTO_EDIT }),
    );
  ...
  it('renders correctly for PLAN mode', () => {
    const { lastFrame } = render(
      _jsx(ApprovalModeIndicator, { approvalMode: ApprovalMode.PLAN }),
    );
    const output = lastFrame();
  ...
  it('renders correctly for YOLO mode', () => {
    const { lastFrame } = render(
      _jsx(ApprovalModeIndicator, { approvalMode: ApprovalMode.YOLO }),
    );
    const output = lastFrame();
  ...
  it('renders nothing for DEFAULT mode', () => {
    const { lastFrame } = render(
      _jsx(ApprovalModeIndicator, { approvalMode: ApprovalMode.DEFAULT }),
    );
    const output = lastFrame();
