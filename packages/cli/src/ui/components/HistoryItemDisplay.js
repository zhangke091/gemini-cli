...
export const HistoryItemDisplay = ({
  item,
    ...
    Box,
    {
      ...
      children: [
        ...
        itemForDisplay.type === 'warning' &&
          _jsx(WarningMessage, { text: itemForDisplay.text }),
        itemForDisplay.type === 'error' &&
          _jsx(ErrorMessage, { text: itemForDisplay.text }),
        ...
        itemForDisplay.type === 'help' &&
          commands &&
          _jsx(Help, { commands: commands }),
        ...
        itemForDisplay.type === 'model_stats' &&
          _jsx(ModelStatsDisplay, {
            selectedAuthType: itemForDisplay.selectedAuthType,
            userEmail: itemForDisplay.userEmail,
            tier: itemForDisplay.tier,
          }),
        itemForDisplay.type === 'tool_stats' && _jsx(ToolStatsDisplay, {}),
        itemForDisplay.type === 'model' &&
          _jsx(ModelMessage, { model: itemForDisplay.model }),
        itemForDisplay.type === 'quit' &&
          _jsx(SessionSummaryDisplay, { duration: itemForDisplay.duration }),
        ...
        itemForDisplay.type === 'compression' &&
          _jsx(CompressionMessage, { compression: itemForDisplay.compression }),
        itemForDisplay.type === 'extensions_list' &&
          _jsx(ExtensionsList, { extensions: itemForDisplay.extensions }),
        ...
        itemForDisplay.type === 'mcp_status' &&
          _jsx(McpStatus, {
            ...itemForDisplay,
            serverStatus: getMCPServerStatus,
          }),
        itemForDisplay.type === 'chat_list' &&
          _jsx(ChatList, { chats: itemForDisplay.chats }),
        itemForDisplay.type === 'hooks_list' &&
          _jsx(HooksList, { hooks: itemForDisplay.hooks }),
      ],
    },
    itemForDisplay.id,
  );
