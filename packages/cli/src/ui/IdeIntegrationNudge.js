    ...
    children: [
      _jsxs(Box, {
        ...
        children: [
          _jsxs(Text, {
            children: [
              _jsx(Text, { color: theme.status.warning, children: '> ' }),
              `Do you want to connect ${ideName ?? 'your editor'} to Gemini CLI?`,
            ],
          }),
          _jsx(Text, { color: theme.text.secondary, children: installText }),
        ],
      }),
      _jsx(RadioButtonSelect, { items: OPTIONS, onSelect: onComplete }),
    ],
  });
}
