...
describe('extensions enable command', () => {
    ...
    describe('handleEnable', () => {
        ...
        it('should auto-enable disabled MCP servers for the extension', async () => {
            ...
            expect(emitConsoleLog).toHaveBeenCalledWith('log', expect.stringContaining("MCP server 'test-server' was disabled"));
            mockCwd.mockRestore();
        });
        it('should not log when MCP servers are already enabled', async () => {
            ...
            expect(emitConsoleLog).not.toHaveBeenCalledWith('log', expect.stringContaining("MCP server 'test-server' was disabled"));
            mockCwd.mockRestore();
        });
    });
