...
describe('extensionsCommand', () => {
    ...
    it('should register all subcommands in builder', () => {
        ...
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'install' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'uninstall' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'list' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'update' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'disable' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'enable' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'link' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'new' }));
        expect(mockYargs.command).toHaveBeenCalledWith(expect.objectContaining({ command: 'validate' }));
