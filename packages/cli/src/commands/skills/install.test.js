...
describe('skill install command', () => {
    ...
    it('should call installSkill with correct arguments for user scope', async () => {
        ...
        expect(mockInstallSkill).toHaveBeenCalledWith('https://example.com/repo.git', 'user', undefined, expect.any(Function), expect.any(Function));
    ...
    it('should call installSkill with correct arguments for workspace scope and subpath', async () => {
        ...
        expect(mockInstallSkill).toHaveBeenCalledWith('https://example.com/repo.git', 'workspace', 'my-skills-dir', expect.any(Function), expect.any(Function));
    });
