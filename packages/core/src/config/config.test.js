...
describe('Server Config (config.ts)', () => {
  ...
  describe('createToolRegistry', () => {
    it('should register a tool if coreTools contains an argument-specific pattern', async () => {
      ...
      const registerToolMock = (await vi.importMock('../tools/tool-registry'))
    ...
    it('should register subagents as tools when agents.overrides.codebase_investigator.enabled is true', async () => {
      ...
      const AgentRegistryMock = (await vi.importMock('../agents/registry.js'))
        .AgentRegistry;
      ...
      const SubAgentToolMock = (
        await vi.importMock('../agents/subagent-tool.js')
      ).SubagentTool;
      await config.initialize();
      const registerToolMock = (await vi.importMock('../tools/tool-registry'))
        .ToolRegistry.prototype.registerTool;
