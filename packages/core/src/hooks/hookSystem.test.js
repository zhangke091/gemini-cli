...
describe('HookSystem Integration', () => {
  ...
  beforeEach(() => {
    ...
    config.getMessageBus = () => undefined;
          ...
          BeforeTool: [
            {
              hooks: [
                {
                  type: 'invalid-type', // Invalid hook type for testing
                  command: './test.sh',
                },
              ],
            },
  ...
  describe('hook disabling via settings', () => {
    it('should not execute disabled hooks from settings', async () => {
      ...
      configWithDisabled.getMessageBus = () => undefined;
  ...
  describe('hook disabling via command', () => {
    it('should disable hook when setHookEnabled is called', async () => {
      ...
      configForDisabling.getMessageBus = () => undefined;
...
//# sourceMappingURL=hookSystem.test.js.map
