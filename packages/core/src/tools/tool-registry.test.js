...
const createMCPTool = (serverName, toolName, description, mockCallable = {}) =>
  ...
  describe('discoverTools', () => {
    it('should will preserve tool parametersJsonSchema during discovery from command', async () => {
      ...
      mockSpawn.mockReturnValue(
        createDiscoveryProcess([unsanitizedToolDeclaration]),
      );
      ...
      const registeredParams = discoveredTool.schema.parametersJsonSchema;
    ...
    it('should return a DISCOVERED_TOOL_EXECUTION_ERROR on tool failure', async () => {
      ...
      mockSpawn.mockReturnValueOnce(
        createExecutionProcess(1, 'Something went wrong'),
      );
