    ...
    async generateSummary(options) {
        ...
        try {
            ...
            if (error instanceof Error && error.name === 'AbortError') {
                ...
                debugLogger.debug(`[SessionSummary] Error generating summary: ${error instanceof Error ? error.message : String(error)}`);
            }
            return null;
        }
    }
}
//# sourceMappingURL=sessionSummaryService.js.map