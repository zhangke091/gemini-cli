...
(function (EventMetadataKey) {
  // Deleted enums: 24
  // Next ID: 144
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_KEY_UNKNOWN'] = 0)] =
    'GEMINI_CLI_KEY_UNKNOWN';
  // ==========================================================================
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_START_SESSION_EMBEDDING_MODEL'] = 2)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_START_SESSION_RESPECT_GITIGNORE'] = 12)
  ] = 'GEMINI_CLI_START_SESSION_RESPECT_GITIGNORE';
  // Logs the output format of the session.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_START_SESSION_OUTPUT_FORMAT'] = 94)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_TOOL_CALL_MCP_SERVER_NAME'] = 95)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_TOOL_CALL_DURATION_MS'] = 17)
  ] = 'GEMINI_CLI_TOOL_CALL_DURATION_MS';
  // Do not use.
  EventMetadataKey[
    (EventMetadataKey['DEPRECATED_GEMINI_CLI_TOOL_ERROR_MESSAGE'] = 18)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_TOOL_CALL_CONTENT_LENGTH'] = 93)
  ] = 'GEMINI_CLI_TOOL_CALL_CONTENT_LENGTH';
  // ==========================================================================
  // Replace Tool Call Event Keys
  // ===========================================================================
  // Logs a edit tool strategy choice.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_EDIT_STRATEGY'] = 109)] =
    'GEMINI_CLI_EDIT_STRATEGY';
  // Logs a edit correction event.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_EDIT_CORRECTION'] = 110)] =
    'GEMINI_CLI_EDIT_CORRECTION';
  // Logs the reason for web fetch fallback.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_WEB_FETCH_FALLBACK_REASON'] = 116)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_API_ERROR_STATUS_CODE'] = 32)
  ] = 'GEMINI_CLI_API_ERROR_STATUS_CODE';
  // Logs the duration of the API call in milliseconds.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_API_ERROR_DURATION_MS'] = 33)
  ...
  // ===========================================================================
  // Logs the Prompt Id
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_PROMPT_ID'] = 35)] =
    'GEMINI_CLI_PROMPT_ID';
  // Logs the Auth type for the prompt, api responses and errors.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_AUTH_TYPE'] = 36)] =
    'GEMINI_CLI_AUTH_TYPE';
  // Logs the total number of Google accounts ever used.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_GOOGLE_ACCOUNTS_COUNT'] = 37)
  ] = 'GEMINI_CLI_GOOGLE_ACCOUNTS_COUNT';
  // Logs the Surface from where the Gemini CLI was invoked, eg: VSCode.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_SURFACE'] = 39)] =
    'GEMINI_CLI_SURFACE';
  // Logs the session id
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_SESSION_ID'] = 40)] =
    'GEMINI_CLI_SESSION_ID';
  // Logs the Gemini CLI version
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_VERSION'] = 54)] =
    'GEMINI_CLI_VERSION';
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_GH_REPOSITORY_NAME_HASH'] = 132)
  ] = 'GEMINI_CLI_GH_REPOSITORY_NAME_HASH';
  // ==========================================================================
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_SLASH_COMMAND_SUBCOMMAND'] = 42)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_RESPONSE_FINISH_REASON'] = 43)
  ] = 'GEMINI_CLI_RESPONSE_FINISH_REASON';
  // Logs the result of the next speaker check
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_NEXT_SPEAKER_CHECK_RESULT'] = 44)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_MALFORMED_JSON_RESPONSE_MODEL'] = 45)
  ...
  // Do not use.
  EventMetadataKey[
    (EventMetadataKey['DEPRECATED_GEMINI_CLI_KITTY_TRUNCATED_SEQUENCE'] = 52)
  ] = 'DEPRECATED_GEMINI_CLI_KITTY_TRUNCATED_SEQUENCE';
  // Logs the length of the kitty sequence that overflowed.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_KITTY_SEQUENCE_LENGTH'] = 53)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_RESEARCH_OPT_IN_STATUS'] = 66)
  ] = 'GEMINI_CLI_RESEARCH_OPT_IN_STATUS';
  // Logs the contact email for research participation
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_RESEARCH_CONTACT_EMAIL'] = 67)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_FILE_OPERATION_MIMETYPE'] = 73)
  ] = 'GEMINI_CLI_FILE_OPERATION_MIMETYPE';
  // Logs the extension of the file in the file operation.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_FILE_OPERATION_EXTENSION'] = 74)
  ...
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_NODE_VERSION'] = 83)] =
    'GEMINI_CLI_NODE_VERSION';
  // ==========================================================================
  ...
  // Logs the name of the extension.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_EXTENSION_ID'] = 121)] =
    'GEMINI_CLI_EXTENSION_ID';
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_EXTENSION_PREVIOUS_VERSION'] = 117)
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_ROUTING_FAILURE_REASON'] = 100)
  ] = 'GEMINI_CLI_ROUTING_FAILURE_REASON';
  // Logs the source of the decision.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_ROUTING_DECISION_SOURCE'] = 101)
  ...
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_AGENT_NAME'] = 111)] =
    'GEMINI_CLI_AGENT_NAME';
  // Logs the unique ID of the agent instance.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_AGENT_ID'] = 112)] =
    'GEMINI_CLI_AGENT_ID';
  ...
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_AGENT_TERMINATE_REASON'] = 115)
  ] = 'GEMINI_CLI_AGENT_TERMINATE_REASON';
  // Logs the reason for an agent recovery attempt.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_AGENT_RECOVERY_REASON'] = 122)
  ] = 'GEMINI_CLI_AGENT_RECOVERY_REASON';
  // Logs the duration of an agent recovery attempt in milliseconds.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_AGENT_RECOVERY_DURATION_MS'] = 123)
  ] = 'GEMINI_CLI_AGENT_RECOVERY_DURATION_MS';
  // Logs whether the agent recovery attempt was successful.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_AGENT_RECOVERY_SUCCESS'] = 124)
  ] = 'GEMINI_CLI_AGENT_RECOVERY_SUCCESS';
  // Logs whether the session is interactive.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_INTERACTIVE'] = 125)] =
    'GEMINI_CLI_INTERACTIVE';
  // ==========================================================================
  // LLM Loop Check Event Keys
  // ==========================================================================
  // Logs the confidence score from the flash model loop check.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_LLM_LOOP_CHECK_FLASH_CONFIDENCE'] = 126)
  ] = 'GEMINI_CLI_LLM_LOOP_CHECK_FLASH_CONFIDENCE';
  // Logs the name of the main model used for the secondary loop check.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_LLM_LOOP_CHECK_MAIN_MODEL'] = 127)
  ] = 'GEMINI_CLI_LLM_LOOP_CHECK_MAIN_MODEL';
  // Logs the confidence score from the main model loop check.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_LLM_LOOP_CHECK_MAIN_MODEL_CONFIDENCE'] = 128)
  ] = 'GEMINI_CLI_LLM_LOOP_CHECK_MAIN_MODEL_CONFIDENCE';
  // Logs the model that confirmed the loop.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_LOOP_DETECTED_CONFIRMED_BY_MODEL'] = 129)
  ] = 'GEMINI_CLI_LOOP_DETECTED_CONFIRMED_BY_MODEL';
  // ==========================================================================
  // Hook Call Event Keys
  // ==========================================================================
  // Logs the name of the hook event (e.g., 'BeforeTool', 'AfterModel').
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_HOOK_EVENT_NAME'] = 133)] =
    'GEMINI_CLI_HOOK_EVENT_NAME';
  // Logs the duration of the hook execution in milliseconds.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_HOOK_DURATION_MS'] = 134)] =
    'GEMINI_CLI_HOOK_DURATION_MS';
  // Logs whether the hook execution was successful.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_HOOK_SUCCESS'] = 135)] =
    'GEMINI_CLI_HOOK_SUCCESS';
  // Logs the exit code of the hook script (if applicable).
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_HOOK_EXIT_CODE'] = 136)] =
    'GEMINI_CLI_HOOK_EXIT_CODE';
  // Logs CPU information of user machine.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_CPU_INFO'] = 137)] =
    'GEMINI_CLI_CPU_INFO';
  // Logs number of CPU cores of user machine.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_CPU_CORES'] = 138)] =
    'GEMINI_CLI_CPU_CORES';
  // Logs GPU information of user machine.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_GPU_INFO'] = 139)] =
    'GEMINI_CLI_GPU_INFO';
  // Logs total RAM in GB of user machine.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_RAM_TOTAL_GB'] = 140)] =
    'GEMINI_CLI_RAM_TOTAL_GB';
  // ==========================================================================
  // Approval Mode Event Keys
  // ==========================================================================
  // Logs the active approval mode in the session.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_ACTIVE_APPROVAL_MODE'] = 141)
  ] = 'GEMINI_CLI_ACTIVE_APPROVAL_MODE';
  // Logs the new approval mode.
  EventMetadataKey[(EventMetadataKey['GEMINI_CLI_APPROVAL_MODE_TO'] = 142)] =
    'GEMINI_CLI_APPROVAL_MODE_TO';
  // Logs the duration spent in an approval mode in milliseconds.
  EventMetadataKey[
    (EventMetadataKey['GEMINI_CLI_APPROVAL_MODE_DURATION_MS'] = 143)
  ] = 'GEMINI_CLI_APPROVAL_MODE_DURATION_MS';
