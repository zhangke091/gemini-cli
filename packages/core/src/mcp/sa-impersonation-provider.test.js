...
describe('ServiceAccountImpersonationProvider', () => {
    ...
    it('should throw an error if no URL is provided', () => {
        const config = {};
        expect(() => new ServiceAccountImpersonationProvider(config)).toThrow('A url or httpUrl must be provided for the Service Account Impersonation provider');
    });
    it('should throw an error if no targetAudience is provided', () => {
        const config = {
            url: 'https://my-iap-service.run.app',
        };
        expect(() => new ServiceAccountImpersonationProvider(config)).toThrow('targetAudience must be provided for the Service Account Impersonation provider');
    });
    it('should throw an error if no targetSA is provided', () => {
        ...
        expect(() => new ServiceAccountImpersonationProvider(config)).toThrow('targetServiceAccount must be provided for the Service Account Impersonation provider');
    });
...
//# sourceMappingURL=sa-impersonation-provider.test.js.map