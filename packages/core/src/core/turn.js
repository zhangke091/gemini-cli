...
(function (CompressionStatus) {
  ...
  CompressionStatus[
    (CompressionStatus['COMPRESSION_FAILED_INFLATED_TOKEN_COUNT'] = 2)
  ] = 'COMPRESSION_FAILED_INFLATED_TOKEN_COUNT';
  /** The compression failed due to an error counting tokens */
  CompressionStatus[
    (CompressionStatus['COMPRESSION_FAILED_TOKEN_COUNT_ERROR'] = 3)
  ] = 'COMPRESSION_FAILED_TOKEN_COUNT_ERROR';
  /** The compression failed because the summary was empty */
  CompressionStatus[
    (CompressionStatus['COMPRESSION_FAILED_EMPTY_SUMMARY'] = 4)
