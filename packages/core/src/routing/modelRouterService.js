...
export class ModelRouterService {
    ...
    async route(context) {
        ...
        try {
            ...
            const event = new ModelRoutingEvent(decision.model, decision.metadata.source, decision.metadata.latencyMs, decision.metadata.reasoning, failed, error_message, enableNumericalRouting, classifierThreshold);
