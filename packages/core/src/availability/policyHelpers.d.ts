 ...
 */
export declare function resolvePolicyChain(
  config: Config,
 ...
 */
export declare function buildFallbackPolicyContext(
...
export declare function resolvePolicyAction(
 ...
 */
export declare function createAvailabilityContextProvider(
  config: Config,
  modelGetter: () => string,
 ...
 */
export declare function selectModelForAvailability(
  config: Config,
 ...
 */
export declare function applyModelSelection(
  config: Config,
...
export declare function applyAvailabilityTransition(
