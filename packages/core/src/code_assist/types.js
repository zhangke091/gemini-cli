...
(function (ConversationInteractionInteraction) {
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['UNKNOWN'] = 0)
  ] = 'UNKNOWN';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['THUMBSUP'] = 1)
  ] = 'THUMBSUP';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['THUMBSDOWN'] = 2)
  ] = 'THUMBSDOWN';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['COPY'] = 3)
  ] = 'COPY';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['INSERT'] = 4)
  ] = 'INSERT';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['ACCEPT_CODE_BLOCK'] = 5)
  ] = 'ACCEPT_CODE_BLOCK';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['ACCEPT_ALL'] = 6)
  ] = 'ACCEPT_ALL';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['ACCEPT_FILE'] = 7)
  ] = 'ACCEPT_FILE';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['DIFF'] = 8)
  ] = 'DIFF';
  ConversationInteractionInteraction[
    (ConversationInteractionInteraction['ACCEPT_RANGE'] = 9)
  ] = 'ACCEPT_RANGE';
})(
  ConversationInteractionInteraction ||
    (ConversationInteractionInteraction = {}),
...
(function (ActionStatus) {
  ActionStatus[(ActionStatus['ACTION_STATUS_UNSPECIFIED'] = 0)] =
    'ACTION_STATUS_UNSPECIFIED';
  ActionStatus[(ActionStatus['ACTION_STATUS_NO_ERROR'] = 1)] =
    'ACTION_STATUS_NO_ERROR';
  ActionStatus[(ActionStatus['ACTION_STATUS_ERROR_UNKNOWN'] = 2)] =
    'ACTION_STATUS_ERROR_UNKNOWN';
  ActionStatus[(ActionStatus['ACTION_STATUS_CANCELLED'] = 3)] =
    'ACTION_STATUS_CANCELLED';
  ActionStatus[(ActionStatus['ACTION_STATUS_EMPTY'] = 4)] =
    'ACTION_STATUS_EMPTY';
})(ActionStatus || (ActionStatus = {}));
export var InitiationMethod;
(function (InitiationMethod) {
  InitiationMethod[(InitiationMethod['INITIATION_METHOD_UNSPECIFIED'] = 0)] =
    'INITIATION_METHOD_UNSPECIFIED';
