...
import { getOauthClient, getConsentForOauth, resetOauthClientForTesting, clearCachedCredentialFile, clearOauthClientCache, authEvents, } from './oauth2.js';
...
import { FatalAuthenticationError, FatalCancellationError, } from '../utils/errors.js';
...
describe('oauth2', () => {
    ...
    describe('getConsentForOauth', () => {
        ...
        it('should use readline when no listeners are present and stdin is a TTY', async () => {
            ...
            expect(writeToStdout).toHaveBeenCalledWith(expect.stringContaining('Do you want to continue? [Y/n]: '));
            mockListenerCount.mockRestore();
            Object.defineProperty(process.stdin, 'isTTY', {
                value: originalIsTTY,
                configurable: true,
        ...
        it('should throw FatalAuthenticationError when no listeners and not a TTY', async () => {
            ...
            await expect(getConsentForOauth()).rejects.toThrow(FatalAuthenticationError);
            mockListenerCount.mockRestore();
            Object.defineProperty(process.stdin, 'isTTY', {
                value: originalIsTTY,
                configurable: true,
