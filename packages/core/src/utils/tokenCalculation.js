 ...
 */
function estimateFunctionResponseTokens(part, depth) {
 ...
 */
export function estimateTokenCountSync(parts, depth = 0) {
...
export async function calculateRequestTokenCount(request, contentGenerator, model) {
    const parts = Array.isArray(request)
...
//# sourceMappingURL=tokenCalculation.js.map