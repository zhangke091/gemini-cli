...
<AdapterType Name="ATimeOut" Comment="Adapter for timed events">
  ...
  describe('processSingleFileContent', () => {
    ...
    it('should process an image file', async () => {
      ...
      expect(result.llmContent.inlineData.data).toBe(
    ...
    it('should process a PDF file', async () => {
      ...
      expect(result.llmContent.inlineData).toBeDefined();
      expect(result.llmContent.inlineData.mimeType).toBe('application/pdf');
      expect(result.llmContent.inlineData.data).toBe(
    ...
    it('should process an audio file', async () => {
      ...
      expect(result.llmContent.inlineData).toBeDefined();
      expect(result.llmContent.inlineData.mimeType).toBe('audio/mpeg');
      expect(result.llmContent.inlineData.data).toBe(
        fakeMp3Data.toString('base64'),
      );
